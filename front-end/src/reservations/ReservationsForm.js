        ...
        <main>
            ...
            <form onSubmit={handleSubmit} aria-label="reservations form">
                ...
                <div className="form-group">
                    ...
                    <input name="mobile_number" id="mobile_number" type="tel" placeholder="###-###-####" className="form-control" onChange={handleChange} value={reservation.mobile_number} />
                ...
                <div className="form-group">
                    ...
                    <input name="reservation_date" id="reservation_date" type="date" placeholder="YYYY-MM-DD" className="form-control" onChange={handleChange} value={reservation.reservation_date} />
                ...
                <div className="form-group">
                    ...
                    <input name="reservation_time" id="reservation_time" type="time" className="form-control" onChange={handleChange} value={reservation.reservation_time} />
